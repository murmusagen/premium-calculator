...
public class PrivateCarDataEntry extends AppCompatActivity {
    ...
    Spinner pvtCarManufacturerSpinner;
    ArrayList<HashMap<String, String>> premium;
    CheckBox evProtectCheckBox;
    CheckBox tyreAndRimProtectorCheckBox,
            lpgCngCheckBox;
    Spinner tyreAndRimProtectorSISpinner;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pvtCarManufacturerSpinner = findViewById(R.id.pvtCarManufacturerSpinner);
        ...
        ArrayAdapter<String> fuelTypeAdapter = new ArrayAdapter<>(this, android.R.layout.simple_spinner_item, CommonFunctions.GCV_FUEL_TYPE);
        ...
        tyreAndRimProtectorSISpinner = findViewById(R.id.tyreAndRimProtectorSISpinner);
        ArrayAdapter<String> tyreAndRimProtectorSIAdapter = new ArrayAdapter<>(this, android.R.layout.simple_spinner_item, CommonFunctions.TYRE_AND_RIM_PROTECTOR_SI_ARRAY);
        tyreAndRimProtectorSIAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        tyreAndRimProtectorSISpinner.setAdapter(tyreAndRimProtectorSIAdapter);
        ...
        evProtectCheckBox = findViewById(R.id.evProtectCheckBox);
        tyreAndRimProtectorCheckBox = findViewById(R.id.tyreAndRimProtectorCheckBox);
        ...
        fuelTypeSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                if (i == 0 || i == 1) {
                    if (evProtectCheckBox.isEnabled()) {
                        evProtectCheckBox.setChecked(false);
                        evProtectCheckBox.setEnabled(false);
                    }
                } else {
                    if (!evProtectCheckBox.isEnabled()) {
                        evProtectCheckBox.setEnabled(true);
                    }
                }
            }
        ...
        tyreAndRimProtectorSISpinner.setEnabled(false);

        tyreAndRimProtectorCheckBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton compoundButton, boolean isChecked) {
                if (isChecked) {
                    tyreAndRimProtectorSISpinner.setSelection(0);
                    tyreAndRimProtectorSISpinner.setEnabled(true);
                } else {
                    tyreAndRimProtectorSISpinner.setSelection(0);
                    tyreAndRimProtectorSISpinner.setEnabled(false);
                }
        ...
        calculateTwPremium.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (ccEditText.getText().toString().equalsIgnoreCase("")) {
                    CommonFunctions.createAlertBuilder(PrivateCarDataEntry.this, "Alert", "Please enter CC/kW", "Ok", "");
                    flag = true;
                    ...
                    CommonFunctions.createAlertBuilder(PrivateCarDataEntry.this, "Alert", "Please enter IDV", "Ok", "");
                    flag = true;
                    ...
                    CommonFunctions.createAlertBuilder(PrivateCarDataEntry.this, "Alert", "Please select No. Of Passenger for PA To Unnamed Passenger", "Ok", "");
                    flag = true;
                } else if (!noOfPassengerEditText.getText().toString().trim().equalsIgnoreCase("") && paToPassengerSISpinner.getSelectedItem().toString().equalsIgnoreCase("NA")) {
                    CommonFunctions.createAlertBuilder(PrivateCarDataEntry.this, "Alert", "Please select Sum Insured for PA To Unnamed Passenger", "Ok", "");
                    flag = true;
                } else if (tyreAndRimProtectorCheckBox.isChecked() && tyreAndRimProtectorSISpinner.getSelectedItem().toString().equalsIgnoreCase("NA")) {
                    CommonFunctions.createAlertBuilder(PrivateCarDataEntry.this, "Alert", "Please select Sum Insured for Tyre Protect", "Ok", "");
                    flag = true;
                } else if (lossOfKeyCheckBox.isChecked() && lossOfKeySISpinner.getSelectedItem().toString().equalsIgnoreCase("NA")) {
                    CommonFunctions.createAlertBuilder(PrivateCarDataEntry.this, "Alert", "Please select Sum Insured for Loss Of Key", "Ok", "");
                    flag = true;
                } else if (personalEffectCheckBox.isChecked() && personalEffectSISpinner.getSelectedItem().toString().equalsIgnoreCase("NA")) {
                    CommonFunctions.createAlertBuilder(PrivateCarDataEntry.this, "Alert", "Please select Sum Insured for Personal Effect", "Ok", "");
                    flag = true;
                }
                ...
                if (!flag) {
                    ...
                    premium = CommonFunctions.calculatePremiumForPrivateCar(
                            pvtCarManufacturerSpinner.getSelectedItem().toString(),
                            ...
                            lossOfKeySISpinner.getSelectedItem().toString(),
                            personalEffectCheckBox.isChecked(),
                            personalEffectSISpinner.getSelectedItem().toString(),
                            evProtectCheckBox.isChecked(),
                            tyreAndRimProtectorCheckBox.isChecked(),
                            tyreAndRimProtectorSISpinner.getSelectedItem().toString(),
                            lpgCngCheckBox.isChecked()
                    );

                    Intent intent = new Intent(PrivateCarDataEntry.this, MotorPremuimDisplay.class);
                    intent.putExtra(CommonFunctions.INTENT_PRODUCT_NAME, CommonFunctions.PRIVATE_CAR);
                    ...
                    intent.putExtra(CommonFunctions.INTENT_MOTOR_MANUFACTURER, pvtCarManufacturerSpinner.getSelectedItem().toString());
